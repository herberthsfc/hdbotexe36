...
case 'lofi':
          ...
          case 'siri':
					hobby = body.slice(1)
					const hob =['Oi rsrs','Sim, Eu acho','Não sei dizer','Por quê?','Sei lá','Eu não quero falar sobre isso','Foda-se','Voce é uma gostosa','kkkkkk','Não fala comigo','Pesquisa no google','Lixo','Meu pau','Eu acho que voce tentou ser engraçado(a)','Eu quero comer uma bolacha','Fdp']
					...
					client.sendMessage(from, 'Nome : *'+cantik+'*\n\nPorcentagem gay : '+ tik+'%', text, { quoted: mek })
					break
                case 'bug':
                case 'reportar':
                case 'reportarbug':
